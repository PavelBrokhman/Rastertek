...
{
	public class MultiTextureShader : ICloneable
	{
		#region Structures
		...
		public bool Initialize(Device device, IntPtr windowHandler)
		{
			...
			return InitializeShader(device, windowHandler, "multitexture.vs", "multitexture.ps");
		}
		...
		private bool InitializeShader(Device device, IntPtr windowHandler, string vsFileName, string psFileName)
		{
			try
			{
				...
				var vertexShaderByteCode = ShaderBytecode.CompileFromFile(vsFileName, "MultiTextureVertexShader", SystemConfiguration.VertexShaderProfile, ShaderFlags.None, EffectFlags.None);
				// Compile the pixel shader code.
				var pixelShaderByteCode = ShaderBytecode.CompileFromFile(psFileName, "MultiTexturePixelShader", SystemConfiguration.PixelShaderProfile, ShaderFlags.None, EffectFlags.None);
