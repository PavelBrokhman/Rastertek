...
bool LightShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, XMFLOAT3 lightDirection,
								  XMFLOAT4 ambientColor, XMFLOAT3 cameraPosition, ID3D11ShaderResourceView* normalsTexture, ID3D11ShaderResourceView* ssaoTexture, XMMATRIX cameraViewMatrix, 
...
void LightShaderClass::ShutdownShader()
{
	...
	// Release the view constant buffer.
	if(m_viewBuffer)
	{
...
bool LightShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, XMFLOAT3 lightDirection, XMFLOAT4 ambientColor, 
											   XMFLOAT3 cameraPosition, ID3D11ShaderResourceView* normalsTexture, ID3D11ShaderResourceView* ssaoTexture, XMMATRIX cameraViewMatrix, 
											   ID3D11ShaderResourceView* colorsTexture)
{
	HRESULT result;
