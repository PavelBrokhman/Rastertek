                                            ...
                                            float* lightViewMatrix2, float* lightProjectionMatrix2, float* diffuseColor2, float* lightPosition2)
{
    ...
    if(location == -1)
    {
        cout << "Light view matrix 2 not set." << endl;
    }
    ...
    if(location == -1)
    {
        cout << "Light projection matrix 2 not set." << endl;
    }
    ...
    if(location == -1)
    {
        cout << "Light position 2 not set." << endl;
    }
    ...
    if(location == -1)
    {
        cout << "Depth map texture 2 not set." << endl;
    }
    ...
    if(location == -1)
    {
        cout << "Diffuse color 2 not set." << endl;
    }
