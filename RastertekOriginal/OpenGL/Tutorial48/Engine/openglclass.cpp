...
bool OpenGLClass::LoadExtensionList()
{
    ...
    glVertexAttribDivisor = (PFNGLVERTEXATTRIBDIVISORPROC)glXGetProcAddress((unsigned char*)"glVertexAttribDivisor");
    if(!glVertexAttribDivisor)
    {
        return false;
    }

    glDrawArraysInstanced = (PFNGLDRAWARRAYSINSTANCEDPROC)glXGetProcAddress((unsigned char*)"glDrawArraysInstanced");
