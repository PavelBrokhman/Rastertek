using RastertekCS.Windows.Tutorial08.Graphics;
using RastertekCS.Windows.Tutorial08.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial08.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial08 - 3D Object Transforms (DirectX 11)";
