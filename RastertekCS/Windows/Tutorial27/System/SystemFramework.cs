using RastertekCS.Windows.Tutorial27.Graphics;
using RastertekCS.Windows.Tutorial27.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial27.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial27 - Clip Plane (DirectX 11)";
