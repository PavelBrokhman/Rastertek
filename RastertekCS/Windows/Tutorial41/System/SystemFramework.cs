using RastertekCS.Windows.Tutorial41.Graphics;
using RastertekCS.Windows.Tutorial41.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial41.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial41 - Shadow Mapping (DirectX 11)";
