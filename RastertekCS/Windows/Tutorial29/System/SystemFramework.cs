using RastertekCS.Windows.Tutorial29.Graphics;
using RastertekCS.Windows.Tutorial29.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial29.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial29 - Transparency (DirectX 11)";
