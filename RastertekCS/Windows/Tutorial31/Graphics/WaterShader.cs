...
public unsafe class WaterShader
{
    ...
    public bool Render(DX11 DirectX, int indexCount,
        Matrix4X4<float> world, Matrix4X4<float> view, Matrix4X4<float> projection, Matrix4X4<float> reflection,
    ...
    {
        if (!SetShaderParameters(DirectX, world, view, projection, reflection,
