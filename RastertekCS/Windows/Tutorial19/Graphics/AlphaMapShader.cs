...
public unsafe class AlphaMapShader
{
    ...
    {
        return InitializeShader(DirectX, "Shaders/AlphaMap.vs", "Shaders/AlphaMap.ps");
    }
        ...
        fixed (byte* pVsSource = vsSource)
        {
            SilkMarshal.ThrowHResult(
                compiler.Compile(
                    ...
                    (byte*)SilkMarshal.StringToPtr("AlphaMapVertexShader", NativeStringEncoding.Ansi),
        ...
        fixed (byte* pPsSource = psSource)
        {
            SilkMarshal.ThrowHResult(
                compiler.Compile(
                    ...
                    null, (ID3DInclude*)null,
                    (byte*)SilkMarshal.StringToPtr("AlphaMapPixelShader", NativeStringEncoding.Ansi),
