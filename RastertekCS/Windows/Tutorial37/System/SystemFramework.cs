using RastertekCS.Windows.Tutorial37.Graphics;
using RastertekCS.Windows.Tutorial37.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial37.System;
...
public class SystemFramework
{
    ...
    public bool Initialize()
    {
        ...
        if (!InitializeWindows(ref screenWidth, ref screenHeight))
            return false;
        if (!_directX.Initialize(_window, screenWidth, screenHeight, SystemConfiguration.ScreenDepth, SystemConfiguration.ScreenNear, SystemConfiguration.VerticalSyncEnabled))
            return false;
        _input = new Input();
        _input.Initialize();
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial37 - Fade (DirectX 11)";
