using RastertekCS.Windows.Tutorial49.Graphics;
using RastertekCS.Windows.Tutorial49.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial49.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial49 - Transparency in Shadow Mapping (DirectX 11)";
