using RastertekCS.Windows.Tutorial43.Graphics;
using RastertekCS.Windows.Tutorial43.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial43.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial43 - Directional Shadow Mapping (DirectX 11)";
