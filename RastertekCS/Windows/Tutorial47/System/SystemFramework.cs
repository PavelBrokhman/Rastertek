using RastertekCS.Windows.Tutorial47.Graphics;
using RastertekCS.Windows.Tutorial47.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial47.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial47 - Bitmap, Font and Light (DirectX 11)";
    ...
    private void OnLoad()
    {
        ...
        {
            mouse.MouseMove += (m, pos) => _input?.SetMouseLocation((int)pos.X, (int)pos.Y);
        }
    }
