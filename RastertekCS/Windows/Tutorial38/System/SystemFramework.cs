using RastertekCS.Windows.Tutorial38.Graphics;
using RastertekCS.Windows.Tutorial38.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial38.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int sw, ref int sh)
    {
        ...
        options.Title = "Tutorial38 - Particles (DirectX 11)";
