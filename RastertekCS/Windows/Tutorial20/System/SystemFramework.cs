using RastertekCS.Windows.Tutorial20.Graphics;
using RastertekCS.Windows.Tutorial20.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial20.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial20 - Normal Mapping (DirectX 11)";
