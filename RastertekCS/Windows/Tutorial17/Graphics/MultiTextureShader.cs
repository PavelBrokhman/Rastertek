...
public unsafe class MultiTextureShader
{
    ...
    {
        return InitializeShader(DirectX, "Shaders/MultiTexture.vs", "Shaders/MultiTexture.ps");
    }
        ...
        fixed (byte* pVsSource = vsSource)
        {
            SilkMarshal.ThrowHResult(
                compiler.Compile(
                    ...
                    (byte*)SilkMarshal.StringToPtr("MultiTextureVertexShader", NativeStringEncoding.Ansi),
        ...
        fixed (byte* pPsSource = psSource)
        {
            SilkMarshal.ThrowHResult(
                compiler.Compile(
                    ...
                    null, (ID3DInclude*)null,
                    (byte*)SilkMarshal.StringToPtr("MultiTexturePixelShader", NativeStringEncoding.Ansi),
