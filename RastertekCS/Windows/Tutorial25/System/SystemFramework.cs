using RastertekCS.Windows.Tutorial25.Graphics;
using RastertekCS.Windows.Tutorial25.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial25.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial25 - Render to Texture (DirectX 11)";
