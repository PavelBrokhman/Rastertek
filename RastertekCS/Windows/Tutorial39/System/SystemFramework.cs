using RastertekCS.Windows.Tutorial39.Graphics;
using RastertekCS.Windows.Tutorial39.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial39.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial39 - Projection (DirectX 11)";
