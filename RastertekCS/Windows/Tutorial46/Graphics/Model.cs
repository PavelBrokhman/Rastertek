...
public unsafe class Model
{
    ...
    public bool Initialize(DX11 DirectX, string modelFilename, string textureFilename1, string textureFilename2, bool wrap)
    {
        ...
        if (!_texture1.Initialize(DirectX, textureFilename1, wrap)) return false;
        _texture2 = new Texture();
        if (!_texture2.Initialize(DirectX, textureFilename2, wrap)) return false;
        return true;
    }

    public void Shutdown()
    {
        _texture2?.Shutdown(); _texture2 = null;
        _texture1?.Shutdown(); _texture1 = null;
    ...
    public ComPtr<ID3D11ShaderResourceView> GetTexture1View() => _texture1.GetTextureView();
    public ComPtr<ID3D11ShaderResourceView> GetTexture2View() => _texture2.GetTextureView();
