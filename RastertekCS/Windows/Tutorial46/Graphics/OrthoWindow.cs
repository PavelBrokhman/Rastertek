...
public unsafe class OrthoWindow
{
    ...
    public bool Initialize(DX11 DirectX, int windowWidth, int windowHeight)
    {
        ...
        {
            var vbDesc = new BufferDesc { Usage = Usage.Default, ByteWidth = (uint)(sizeof(VertexType) * 6), BindFlags = (uint)BindFlag.VertexBuffer };
        ...
        {
            var ibDesc = new BufferDesc { Usage = Usage.Default, ByteWidth = (uint)(sizeof(uint) * 6), BindFlags = (uint)BindFlag.IndexBuffer };
