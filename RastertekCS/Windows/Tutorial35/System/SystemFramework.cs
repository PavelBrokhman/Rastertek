using RastertekCS.Windows.Tutorial35.Graphics;
using RastertekCS.Windows.Tutorial35.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial35.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial35 - Depth Buffer (DirectX 11)";
