using RastertekCS.Windows.Tutorial11.Graphics;
using RastertekCS.Windows.Tutorial11.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial11.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial11 - Multiple Point Lights (DirectX 11)";
