using RastertekCS.Windows.Tutorial51.Graphics;
using RastertekCS.Windows.Tutorial51.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial51.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial51 - Screen Space Ambient Occlusion (DirectX 11)";
