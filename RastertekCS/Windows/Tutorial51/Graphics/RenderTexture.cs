...
public unsafe class RenderTexture
{
    ...
    )
    {
        ...
        // rendertextureclass.cpp: 1 is the colour format, 2 the single-channel
        // float used for the ssao and blur targets.
        var textureFormat = format switch
        {
            2 => Format.FormatR32Float,
        ...
        _orthoMatrix = DXMath.OrthographicLH(textureWidth, textureHeight, screenNear, screenDepth);
