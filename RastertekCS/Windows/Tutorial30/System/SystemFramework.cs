using RastertekCS.Windows.Tutorial30.Graphics;
using RastertekCS.Windows.Tutorial30.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial30.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial30 - Planar Reflection (DirectX 11)";
