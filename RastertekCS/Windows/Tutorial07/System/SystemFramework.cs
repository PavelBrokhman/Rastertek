using RastertekCS.Windows.Tutorial07.Graphics;
using RastertekCS.Windows.Tutorial07.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial07.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial07 - 3D Model Rendering (DirectX 11)";
