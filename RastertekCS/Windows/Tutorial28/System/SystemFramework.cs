using RastertekCS.Windows.Tutorial28.Graphics;
using RastertekCS.Windows.Tutorial28.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial28.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial28 - Texture Translation (DirectX 11)";
