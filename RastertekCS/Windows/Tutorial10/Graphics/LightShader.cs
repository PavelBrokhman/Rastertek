...
public unsafe class LightShader
{
    ...
    private struct LightBufferType
    {
        ...
        public float specularColorR, specularColorG, specularColorB, specularColorA;
    }
        ...
        float[] cameraPosition, float[] specularColor, float specularPower)
    {
        if (!SetShaderParameters(DirectX, worldMatrix, viewMatrix, projectionMatrix,
            lightDirection, diffuseLightColor, ambientColor, cameraPosition, specularColor, specularPower))
            return false;
