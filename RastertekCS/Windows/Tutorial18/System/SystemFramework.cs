using RastertekCS.Windows.Tutorial18.Graphics;
using RastertekCS.Windows.Tutorial18.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial18.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial18 - Light Maps (DirectX 11)";
