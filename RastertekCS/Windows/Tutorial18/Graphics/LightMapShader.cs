...
public unsafe class LightMapShader
{
    ...
    {
        return InitializeShader(DirectX, "Shaders/LightMap.vs", "Shaders/LightMap.ps");
    }
        ...
        fixed (byte* pVsSource = vsSource)
        {
            SilkMarshal.ThrowHResult(
                compiler.Compile(
                    ...
                    (byte*)SilkMarshal.StringToPtr("LightMapVertexShader", NativeStringEncoding.Ansi),
        ...
        fixed (byte* pPsSource = psSource)
        {
            SilkMarshal.ThrowHResult(
                compiler.Compile(
                    ...
                    null, (ID3DInclude*)null,
                    (byte*)SilkMarshal.StringToPtr("LightMapPixelShader", NativeStringEncoding.Ansi),
