...
public unsafe class DX11
{
    ...
    private ComPtr<ID3D11BlendState> m_blendEnableState;
    private ComPtr<ID3D11BlendState> m_blendDisableState;
                           ...
                           float screenDepth, float screenNear, bool vsync)
    {
        ...
        SilkMarshal.ThrowHResult(m_device.CreateBlendState(&blendDesc, ref m_blendEnableState));

        blendDesc.RenderTarget[0].BlendEnable = false;
        SilkMarshal.ThrowHResult(m_device.CreateBlendState(&blendDesc, ref m_blendDisableState));
    ...
    public void EnableAlphaBlending()
    {
        ...
        m_deviceContext.OMSetBlendState(m_blendEnableState, bf, 0xFFFFFFFF);
    }

    public void DisableAlphaBlending()
    {
        float* bf = stackalloc float[4] { 0, 0, 0, 0 };
        m_deviceContext.OMSetBlendState(m_blendDisableState, bf, 0xFFFFFFFF);
    }
