using RastertekCS.Windows.Tutorial33.Graphics;
using RastertekCS.Windows.Tutorial33.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial33.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial33 - Fire (DirectX 11)";
