using RastertekCS.Windows.Tutorial24.Graphics;
using RastertekCS.Windows.Tutorial24.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial24.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial24 - Loading Maya Models (DirectX 11)";
