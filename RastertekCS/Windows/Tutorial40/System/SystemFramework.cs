using RastertekCS.Windows.Tutorial40.Graphics;
using RastertekCS.Windows.Tutorial40.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial40.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial40 - Projected Texture with Lighting (DirectX 11)";
