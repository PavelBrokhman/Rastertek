...
public unsafe class ProjectionShader
{
    private struct MatrixBufferType
    {
        ...
        public Matrix4X4<float> view2;
        public Matrix4X4<float> projection2;
    }
    ...
    public bool Initialize(DX11 DirectX) =>
        InitializeShader(DirectX, "Shaders/projection.vs", "Shaders/projection.ps");
    ...
    public bool Render(
        ...
        Matrix4X4<float> viewMatrix2,
        Matrix4X4<float> projectionMatrix2,
        ComPtr<ID3D11ShaderResourceView> texture,
        ComPtr<ID3D11ShaderResourceView> projectionTexture,
    ...
    {
        if (!SetShaderParameters(DirectX, worldMatrix, viewMatrix, projectionMatrix, viewMatrix2, projectionMatrix2,
                                 texture, projectionTexture, diffuseColor, ambientColor, lightPosition, brightness))
            return false;
        ...
        fixed (byte* pVsSource = vsSource)
            SilkMarshal.ThrowHResult(
                compiler.Compile(
                    ...
                    null,
                    (ID3DInclude*)null,
                    (byte*)SilkMarshal.StringToPtr("ProjectionVertexShader", NativeStringEncoding.Ansi),
        ...
        fixed (byte* pPsSource = psSource)
            SilkMarshal.ThrowHResult(
                compiler.Compile(
                    ...
                    null,
                    (ID3DInclude*)null,
                    (byte*)SilkMarshal.StringToPtr("ProjectionPixelShader", NativeStringEncoding.Ansi),
    ...
    )
    {
        ...
        viewMatrix2 = Matrix4X4.Transpose(viewMatrix2);
        projectionMatrix2 = Matrix4X4.Transpose(projectionMatrix2);
        ...
        mp->view2 = viewMatrix2;
        mp->projection2 = projectionMatrix2;
        ...
        lpp->lightPosition = lightPosition;
        lpp->padding = 0.0f;
        ...
        var srv1 = projectionTexture.GetPinnableReference();
