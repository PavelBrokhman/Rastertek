using RastertekCS.Windows.Tutorial06.Graphics;
using RastertekCS.Windows.Tutorial06.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial06.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial06 - Diffuse Lighting";
