using RastertekCS.Windows.Tutorial45.Graphics;
using RastertekCS.Windows.Tutorial45.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial45.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial45 - Transparency in Shadow Mapping (DirectX 11)";
