...
public unsafe class ShadowShader
{
    ...
    public bool Render(DX11 DirectX, int indexCount,
        ...
        Vector3D<float> lightPosition, float bias)
    {
        if (!SetShaderParameters(DirectX, world, view, projection, lightView, lightProjection, depthMapTexture, lightPosition, bias)) return false;
        ...
        Vector3D<float> lightPosition, float bias)
    {
        ...
        var srv = depthMapTexture.GetPinnableReference();
