using RastertekCS.Windows.Tutorial44.Graphics;
using RastertekCS.Windows.Tutorial44.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial44.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial44 - Soft Shadows (DirectX 11)";
