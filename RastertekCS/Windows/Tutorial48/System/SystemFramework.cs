using RastertekCS.Windows.Tutorial48.Graphics;
using RastertekCS.Windows.Tutorial48.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial48.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial48 - Transparency in Shadow Mapping (DirectX 11)";
