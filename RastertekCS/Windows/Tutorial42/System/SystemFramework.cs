using RastertekCS.Windows.Tutorial42.Graphics;
using RastertekCS.Windows.Tutorial42.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial42.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial42 - Shadow Mapping with Multiple Lights (DirectX 11)";
