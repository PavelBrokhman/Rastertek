using RastertekCS.Windows.Tutorial22.Graphics;
using RastertekCS.Windows.Tutorial22.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial22.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial22 - Shader Manager (DirectX 11)";
