using RastertekCS.Windows.Tutorial53.Graphics;
using RastertekCS.Windows.Tutorial53.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.Windows.Tutorial53.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int screenWidth, ref int screenHeight)
    {
        ...
        options.Title = "Tutorial53 - Heat Distortion (DirectX 11)";
