...
public class Model
{
    ...
    public unsafe bool Initialize(GL4 OpenGL, string modelFilename,
        ...
        string textureFilename3, uint textureUnit3)
    {
        ...
        if (!m_Texture3.Initialize(OpenGL, textureFilename3, textureUnit3, true)) return false;
    ...
    public void SetTextures(GL4 OpenGL, uint textureUnit1, uint textureUnit2, uint textureUnit3)
    {
        ...
        m_Texture3?.SetTexture(OpenGL, textureUnit3);
    }
