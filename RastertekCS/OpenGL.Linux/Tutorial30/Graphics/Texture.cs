...
public class Texture
{
    ...
    private static void GenerateCheckerboardTga(string filename, int size)
    {
        ...
        if (name.Contains("stone") || name.Contains("red")) { cr = 180; cg = 140; cb = 100; }
        else if (name.Contains("blue")) { cr = 40; cg = 40; cb = 220; }
        else if (name.Contains("green")) { cr = 40; cg = 220; cb = 40; }
