using RastertekCS.OpenGL.Tutorial06.Graphics;
using RastertekCS.OpenGL.Tutorial06.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.OpenGL.Tutorial06.System;
...
public class SystemFramework
{
    ...
    public bool Initialize()
    {
        int sw = 0, sh = 0;
        m_OpenGL = new GL4();
        if (!InitializeWindows(ref sw, ref sh)) { global::System.Console.WriteLine("Не удалось инициализировать окно."); return false; }
        if (!m_OpenGL.Initialize(m_window, sw, sh, SystemConfiguration.ScreenDepth,
                                  SystemConfiguration.ScreenNear, SystemConfiguration.VerticalSyncEnabled))
        { global::System.Console.WriteLine("Не удалось инициализировать OpenGL."); return false; }
