using RastertekCS.OpenGL.Tutorial15.Graphics;
using RastertekCS.OpenGL.Tutorial15.Inputs;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int sw, ref int sh)
    {
        ...
        options.Title = "Tutorial15 - FPS Counter (OpenGL)";
        ...
        m_window.Initialize();
        m_window.Title = "Tutorial15 - FPS Counter (OpenGL)";
        sw = m_window.Size.X;
        sh = m_window.Size.Y;
        return true;
    }
    ...
    private void OnRender(double dt)
    {
        ...
        if (!m_Graphics.Frame(m_Fps.GetFps()))
        {
            m_done = true;
            m_window.Close();
        }
