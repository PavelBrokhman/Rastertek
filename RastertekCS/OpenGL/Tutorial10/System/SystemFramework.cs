using RastertekCS.OpenGL.Tutorial10.Graphics;
using RastertekCS.OpenGL.Tutorial10.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.OpenGL.Tutorial10.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int sw, ref int sh)
    {
        ...
        options.Title = "Tutorial10 - Specular Lighting (OpenGL)";
        ...
        m_window.Initialize();
        m_window.Title = "Tutorial10 - Specular Lighting (OpenGL)";
