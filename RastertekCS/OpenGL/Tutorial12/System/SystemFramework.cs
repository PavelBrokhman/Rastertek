using RastertekCS.OpenGL.Tutorial12.Graphics;
using RastertekCS.OpenGL.Tutorial12.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.OpenGL.Tutorial12.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int sw, ref int sh)
    {
        ...
        options.Title = "Tutorial12 - 2D Bitmap Rendering (OpenGL)";
        ...
        m_window.Initialize();
        m_window.Title = "Tutorial12 - 2D Bitmap Rendering (OpenGL)";
