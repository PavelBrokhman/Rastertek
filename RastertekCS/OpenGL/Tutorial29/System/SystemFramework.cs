using RastertekCS.OpenGL.Tutorial29.Graphics;
using RastertekCS.OpenGL.Tutorial29.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.OpenGL.Tutorial29.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int sw, ref int sh)
    {
        ...
        options.Title = "Tutorial 29: Transparency";
