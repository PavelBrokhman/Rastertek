using RastertekCS.OpenGL.Tutorial25.Graphics;
using RastertekCS.OpenGL.Tutorial25.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.OpenGL.Tutorial25.System;
