using RastertekCS.OpenGL.Tutorial38.Graphics;
using RastertekCS.OpenGL.Tutorial38.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.OpenGL.Tutorial38.System;

public class SystemFramework
{
    private IWindow m_window; private IInputContext m_inputContext;
    private GL4 m_OpenGL; private Input m_Input; private GraphicsFramework m_Graphics;
    ...
    public bool Initialize()
    {
        ...
        m_graphicsInitialized = true; return true;
    }
    ...
    private bool InitializeWindows(ref int sw, ref int sh)
    {
        ...
        m_window.Initialize(); m_window.Title = "Tutorial38"; sw = m_window.Size.X; sh = m_window.Size.Y; return true;
    }
    ...
    private void OnRender(double dt)
    {
        ...
        if (!m_Graphics.Frame((float)dt)) { m_done = true; m_window.Close(); }
    }
