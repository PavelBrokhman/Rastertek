...
public class GL4
{
    ...
    public void EnableAlphaBlending() { m_gl.Enable(EnableCap.Blend); m_gl.BlendFuncSeparate(BlendingFactor.One, BlendingFactor.One, BlendingFactor.One, BlendingFactor.One); }
