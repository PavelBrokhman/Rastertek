...
public class GraphicsFramework
{
    ...
    public bool Initialize(GL4 gl4, int sw, int sh)
    {
        ...
        m_GroundModel = new Model(); if (!m_GroundModel.Initialize(gl4, "Data/plane01.txt", "Data/metal001.tga")) return false;
        m_CubeModel = new Model(); if (!m_CubeModel.Initialize(gl4, "Data/cube.txt", "Data/stone01.tga")) return false;
