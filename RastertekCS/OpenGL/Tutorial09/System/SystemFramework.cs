using RastertekCS.OpenGL.Tutorial09.Graphics;
using RastertekCS.OpenGL.Tutorial09.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.OpenGL.Tutorial09.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int sw, ref int sh)
    {
        ...
        _window.Initialize();
        _window.Title = "Tutorial09 - Ambient Lighting (OpenGL)";
        sw = _window.Size.X;
        sh = _window.Size.Y;
        return true;
    }
