...
public class SoftShadowShader
{
    private uint _vertexShader,
        _fragmentShader,
        _shaderProgram;

    public bool Initialize(GL4 OpenGL) => InitializeShader(OpenGL, "Shaders/SoftShadow.vs", "Shaders/SoftShadow.ps");
    ...
    )
    {
        ...
        gl.Uniform1(loc, 0);
        loc = gl.GetUniformLocation(_shaderProgram, "shadowTexture"); if (loc == -1) return false;
        gl.Uniform1(loc, 1);
