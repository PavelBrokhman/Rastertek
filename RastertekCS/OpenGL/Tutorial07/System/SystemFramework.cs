using RastertekCS.OpenGL.Tutorial07.Graphics;
using RastertekCS.OpenGL.Tutorial07.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.OpenGL.Tutorial07.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int sw, ref int sh)
    {
        ...
        options.Title = "Tutorial07 - 3D Model Rendering (OpenGL)";
