using RastertekCS.OpenGL.Tutorial08.Graphics;
using RastertekCS.OpenGL.Tutorial08.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.OpenGL.Tutorial08.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int sw, ref int sh)
    {
        ...
        options.Title = "Tutorial08 - 3D Object Transforms (OpenGL)";
        ...
        m_window.Initialize();
        m_window.Title = "Tutorial08 - 3D Object Transforms (OpenGL)";
