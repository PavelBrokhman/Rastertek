using RastertekCS.OpenGL.Tutorial30.Graphics;
using RastertekCS.OpenGL.Tutorial30.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.OpenGL.Tutorial30.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int sw, ref int sh)
    {
        ...
        options.Title = "Tutorial 30 - Planar Reflection";
