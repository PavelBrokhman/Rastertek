...
public class GraphicsFramework
{
    ...
    public bool Initialize(GL4 gl, int sw, int sh)
    {
        ...
        m_model = new Model(); if (!m_model.Initialize(gl, "Data/cube.txt", "Data/stone01.tga", false, "Data/normal03.tga", false)) return false;
        m_winModel = new Model(); if (!m_winModel.Initialize(gl, "Data/square.txt", "Data/glass01.tga", false, "Data/normal03.tga", false)) return false;
