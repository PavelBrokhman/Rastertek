...
public class FontShader
{
    ...
    public unsafe bool SetShaderParameters(GL4 OpenGL,
        ...
        int textureUnit, Vector4D<float> pixelColor)
    {
        var gl = OpenGL.Driver;
        ...
        loc = gl.GetUniformLocation(_shaderProgram, "pixelColor"); if (loc == -1) return false;
        gl.Uniform4(loc, pixelColor.X, pixelColor.Y, pixelColor.Z, pixelColor.W);
        return true;
    }
