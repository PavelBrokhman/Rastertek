using RastertekCS.OpenGL.Tutorial04.Graphics;
using RastertekCS.OpenGL.Tutorial04.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.OpenGL.Tutorial04.System;
