using RastertekCS.OpenGL.Tutorial54.Graphics;
using RastertekCS.OpenGL.Tutorial54.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.OpenGL.Tutorial54.System;
