...
public class FadeShader
{
    ...
    public bool Initialize(GL4 gl4) => Init(gl4, "Shaders/Fade.vs", "Shaders/Fade.ps");
    ...
    public bool SetShaderParameters(GL4 gl4, Matrix4X4<float> w, Matrix4X4<float> v, Matrix4X4<float> p, float fadeAmount)
    {
        ...
        loc=g.GetUniformLocation(m_prog,"fadeAmount"); if(loc==-1) return false; g.Uniform1(loc,fadeAmount);
        return true;
    }
