using RastertekCS.OpenGL.Tutorial53.Graphics;
using RastertekCS.OpenGL.Tutorial53.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.OpenGL.Tutorial53.System;
