using RastertekCS.OpenGL.Tutorial52.Graphics;
using RastertekCS.OpenGL.Tutorial52.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.OpenGL.Tutorial52.System;
