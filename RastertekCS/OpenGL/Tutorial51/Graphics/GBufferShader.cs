...
public class GBufferShader
{
    ...
    public bool Initialize(GL4 OpenGL) => InitializeShader(OpenGL, "Shaders/GBuffer.vs", "Shaders/GBuffer.ps");
    ...
    public unsafe bool SetShaderParameters(GL4 OpenGL, Matrix4X4<float> world, Matrix4X4<float> view, Matrix4X4<float> projection, int textureUnit)
    {
        var gl = OpenGL.Gl;
        ...
        loc = gl.GetUniformLocation(m_shaderProgram, "shaderTexture"); if (loc == -1) return false;
