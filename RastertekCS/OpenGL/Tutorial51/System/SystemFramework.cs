using RastertekCS.OpenGL.Tutorial51.Graphics;
using RastertekCS.OpenGL.Tutorial51.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.OpenGL.Tutorial51.System;
