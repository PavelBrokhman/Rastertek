using RastertekCS.OpenGL.Tutorial11.Graphics;
using RastertekCS.OpenGL.Tutorial11.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.OpenGL.Tutorial11.System;
...
public class SystemFramework
{
    ...
    private bool InitializeWindows(ref int sw, ref int sh)
    {
        ...
        options.Title = "Tutorial11 - Multiple Point Lights (OpenGL)";
        ...
        m_window.Initialize();
        m_window.Title = "Tutorial11 - Multiple Point Lights (OpenGL)";
        sw = m_window.Size.X;
        sh = m_window.Size.Y;
        return true;
    }
