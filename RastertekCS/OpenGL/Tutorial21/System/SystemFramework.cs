using RastertekCS.OpenGL.Tutorial21.Graphics;
using RastertekCS.OpenGL.Tutorial21.Inputs;
using Silk.NET.Input;
using Silk.NET.Maths;
using Silk.NET.Windowing;

namespace RastertekCS.OpenGL.Tutorial21.System;
