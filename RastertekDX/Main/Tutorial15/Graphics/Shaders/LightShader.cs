...
using GraphicsClass = Tutorial15.Graphics.Graphics;
using InputClass = Tutorial15.Inputs.Input;
using MapFlags = SharpDX.Direct3D11.MapFlags;
using System.Runtime.InteropServices;
using Tutorial15.System;

namespace Tutorial15.Graphics.Shaders
{
	public class LightShader : ICloneable
	{
		...
		{
			public const int TotalSize = ShaderUtilities.Vector3Alignment * 2 + ShaderUtilities.Vector2Alignment;

			[FieldOffset(ShaderUtilities.ZeroAlignment)]
			public Vector3 position;
			[FieldOffset(ShaderUtilities.Vector3Alignment)]
			public Vector2 texture;
			[FieldOffset(ShaderUtilities.Vector3Alignment + ShaderUtilities.Vector2Alignment)]
		...
		{
			public const int TotalSize = ShaderUtilities.MatrixAlignment * 3;

			[FieldOffset(ShaderUtilities.ZeroAlignment)]
			public Matrix world;
			[FieldOffset(ShaderUtilities.MatrixAlignment)]
			public Matrix view;
			[FieldOffset(ShaderUtilities.MatrixAlignment * 2)]
		...
		{
			public const int TotalSize = ShaderUtilities.Vector3Alignment + ShaderUtilities.FloatAlignment;
		...
		{
			public const int TotalSize = ShaderUtilities.Vector3Alignment + ShaderUtilities.Vector4Alignment * 3 + ShaderUtilities.FloatAlignment;

			[FieldOffset(ShaderUtilities.ZeroAlignment)]
			public Vector4 ambientColor;
			[FieldOffset(ShaderUtilities.Vector4Alignment)]
			public Vector4 diffuseColor;
			[FieldOffset(ShaderUtilities.Vector4Alignment * 2)]
			public Vector3 lightDirection;
			[FieldOffset(ShaderUtilities.Vector4Alignment * 2 + ShaderUtilities.Vector3Alignment)]
			public float specularPower;
			[FieldOffset(ShaderUtilities.Vector4Alignment * 2 + ShaderUtilities.Vector3Alignment + ShaderUtilities.FloatAlignment)]
			...
			try
			{
				...
				var inputElements = new InputElement[]
				{
					...
					new InputElement()
					{
						...
						Format = Format.R32G32B32_Float,
						Slot = 0,
						AlignedByteOffset = ShaderUtilities.Vector3Alignment + ShaderUtilities.Vector2Alignment,
						Classification = InputClassification.PerVertexData,
						InstanceDataStepRate = 0
					}
				};
