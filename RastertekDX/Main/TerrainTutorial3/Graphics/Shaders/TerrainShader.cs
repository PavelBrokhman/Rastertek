...
{
	public class HeightMapTerrainShader : ICloneable
	{
		#region Structures
		...
		public bool Initialize(Device device, IntPtr windowHandler)
		{
			...
			return InitializeShader(device, windowHandler, "HeightMapTerrain.vs", "HeightMapTerrain.ps");
		}
		...
		public bool Render(DeviceContext deviceContext, int indexCount, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, Vector3 lightDirection, Vector4 ambientColor, Vector4 diffuseColor)
		{
			// Set the shader parameters that it will use for rendering.
			if (!SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix,  lightDirection, ambientColor, diffuseColor))
				return false;
		...
		private bool SetShaderParameters(DeviceContext deviceContext, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, Vector3 lightDirection, Vector4 ambientColor, Vector4 diffuseColor)
		{
			try
			{
