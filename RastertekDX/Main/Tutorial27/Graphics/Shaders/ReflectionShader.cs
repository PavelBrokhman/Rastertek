	...
	public class ReflectionShader : ICloneable
	{
		...
		private bool InitializeShader(Device device, IntPtr windowHandler, string vsFileName, string psFileName)
		{
			try
			{
				...
				var vertexShaderByteCode = ShaderBytecode.CompileFromFile(vsFileName, "ReflectionVertexShader", SystemConfiguration.VertexShaderProfile, ShaderFlags.None, EffectFlags.None);
				// Compile the pixel shader code.
				var pixelShaderByteCode = ShaderBytecode.CompileFromFile(psFileName, "ReflectionPixelShader", SystemConfiguration.PixelShaderProfile, ShaderFlags.None, EffectFlags.None);
		...
		private bool SetShaderParameters(DeviceContext deviceContext, Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, ShaderResourceView texture, ShaderResourceView reflectionTexture, Matrix reflectionMatrix)
		{
			try
			{
				...
				// Finally set the constant buffer in the vertex shader with the updated values.
				deviceContext.PixelShader.SetConstantBuffer(bufferNumber, ConstantReflectionBuffer);
