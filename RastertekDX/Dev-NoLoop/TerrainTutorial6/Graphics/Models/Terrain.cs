...
namespace Engine.Graphics.Models
{
	public class Terrain : ICloneable
	{
		...
		protected PrimitiveTopology CurrentTopology { get; set; }
		#endregion
		...
		public bool Initialize(Device device)
		{
			...
			CurrentTopology = PrimitiveTopology.LineList;
		...
		protected virtual void RenderBuffers(DeviceContext deviceContext)
		{
