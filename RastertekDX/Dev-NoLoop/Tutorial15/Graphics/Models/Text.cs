...
using System.Linq;
using System.Text;
using Tutorial15.Graphics.Data;
using Tutorial15.Graphics.Shaders;
using SharpDX;
...
namespace Tutorial15.Graphics.Models
{
	public class Text
	{
		#region Structures
		...
		public bool Initialize(Device device, DeviceContext deviceContext, IntPtr windowHandle, int screanWidth, int screenHeight, Matrix baseViewMatrix)
		{
			...
			// Now update the sentence vertex buffer with the new string information.
			if (!UpdateSentence(ref sentences[1], "Goodbye", 100, 200, 1, 1, 0, deviceContext))
				return false;
