...
namespace Engine.Graphics.Shaders
{
	public class HeightMapTerrainShader : ICloneable
	{
		...
		public bool Initialize(Device device, IntPtr windowHandler)
		{
			...
			return InitializeShader(device, windowHandler, "TexHeightMapTerrain.vs", "TexHeightMapTerrain.ps");
		}
		...
		public bool Render(DeviceContext deviceContext, int indexCount, 
			Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix, 
			Vector3 lightDirection, Vector4 ambientColor, Vector4 diffuseColor,
		...
		private bool SetShaderParameters(DeviceContext deviceContext, 
			Matrix worldMatrix, Matrix viewMatrix, Matrix projectionMatrix,
			Vector3 lightDirection, Vector4 ambientColor, Vector4 diffuseColor,
			ShaderResourceView texture)
		{
