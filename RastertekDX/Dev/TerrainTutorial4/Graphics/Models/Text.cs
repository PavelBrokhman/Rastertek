...
namespace Engine.Graphics.Models
{
	public class Text
	{
		...
		Sentence[] sentences = new Sentence[10];
		#endregion
		...
		{
			//RenderSentence(deviceContext, sentences[0], worldMatrix, orthoMatrix);
			//RenderSentence(deviceContext, sentences[1], worldMatrix, orthoMatrix);
