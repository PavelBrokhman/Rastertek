...
namespace Tutorial15.Graphics.Shaders
{
	public class FontShader : ICloneable
	{
		...
		{
			public const int TotalSize = ShaderUtilities.Vector3Alignment + ShaderUtilities.Vector2Alignment;
		...
		{
			public const int TotalSize = ShaderUtilities.Vector4Alignment;
